...
const CoffeeEditPage = (props) => {
    ...
    const getCoffee = async () => {
        ...
        await RestClient.getRequest(AppUrl.coffees_edit + `/${params.code}`, {
            headers: {
    ...
    const _handleSubmit = async (values, {resetForm, setSubmitting}) => {
        ...
        await RestClient.postRequest(AppUrl.coffees_update + `/${params.code}`, values, {
            headers: {
                "Authorization": "Bearer " + token,
        ...
        isLoading ? (
            ...
            <>
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 className="h3 mb-0 text-gray-800">Kahve Güncelle</h1>
                </div>
                        ...
                        <div className="card shadow mb-4">
                            ...
                            <div className="card-body container-fluid">
                                <Formik enableReinitialize={true} initialValues={{
                                    cf_code: coffee.cf_code,
                                    cf_category: coffee.cf_category,
                                    cf_name: coffee.cf_name,
                                    cf_desc: coffee.cf_desc,
                                    cf_roasted: coffee.cf_roasted,
                                    cf_ingredients: coffee.cf_ingredients,
                                    cf_image: coffee.cf_image
                                        ...
                                        <form className={"form-group"} method={"POST"}>
                                            <div className={"row"}>
                                                <div className={"col-md-4"}>
                                                    ...
                                                    <input value={values.cf_code} onChange={handleChange('cf_code')}
                                                           onBlur={handleBlur} name={"cf_code"}
                                                ...
                                                <div className={"col-md-4"}>
                                                    ...
                                                    <select name={"cf_category"} value={values.cf_category}
                                                        ...
                                                        {categories.map((item, index) => (
                                                            <option key={index}
                                                                    value={item.cfc_code}>{item.cfc_name}</option>
                                                        ))}
                                                    </select>
                                                ...
                                                <div className={"col-md-4"}>
                                                    ...
                                                    <input value={values.cf_name} onChange={handleChange('cf_name')}
                                                           onBlur={handleBlur} name={"cf_name"}
                                                           className={"form-control"}/>
                                            ...
                                            <div className={"row mt-2"}>
                                                <div className={"col-md-6"}>
                                                    ...
                                                    <input value={values.cf_roasted}
                                                           onChange={handleChange('cf_roasted')}
                                                ...
                                                <div className={"col-md-6"}>
                                                    ...
                                                    {(touched.cf_ingredients && errors.cf_ingredients) &&
                                                        <small
                                                            className={"text-danger"}>{errors.cf_ingredients}</small>}
                                                </div>
                                            </div>
                                            {previewImage ? (
                                                ...
                                                <div className={"col-md-12 mt-3"}>
                                                    <img src={AppUrl.imageUrl+coffee.cf_image} style={{width: '100px', height: '100px'}}/>
                                                </div>
                                            )}
                                            <div className={"row mt-2"}>
                                                <div className={"col-md-12"}>
...
export default inject("AuthStore")(observer(CoffeeEditPage));
